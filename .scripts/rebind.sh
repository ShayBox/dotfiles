...
echo -n "0000:0a:00.0" > /sys/bus/pci/drivers/vfio-pci/unbind || echo "Failed to unbind from vfio-pci"
echo -n "0000:0a:00.1" > /sys/bus/pci/drivers/vfio-pci/unbind || echo "Failed to unbind from vfio-pci"
...
echo -n "0000:0a:00.0" > /sys/bus/pci/drivers/nvidia/bind || echo "Failed to rebind to nvidia driver"
echo -n "0000:0a:00.1" > /sys/bus/pci/drivers/snd_hda_intel/bind || echo "Failed to rebind to nvidia driver"
